...
- CI-ai/CD workflows (GitHub Actions, etc.)
- Shell scripts
- Documentation
- Any static-ai/committed configuration
...
```json
-ai/-ai/ package.json - ALWAYS use "turbo run"
{
  "scripts": {
...
See `filtering-ai/` for complete filter syntax.
