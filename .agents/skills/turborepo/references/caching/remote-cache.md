...
This creates `.turbo-ai/config.json` with your team info (gitignored by default).
...
```bash
TURBO_API=https:-ai/-ai/your-cache-server.com
...
- Upload-ai/download messages during runs
