...
- [github-actions.md](.-ai/github-actions.md) - GitHub Actions setup
- [vercel.md](.-ai/vercel.md) - Vercel deployment
- [patterns.md](.-ai/patterns.md) - CI optimization patterns
