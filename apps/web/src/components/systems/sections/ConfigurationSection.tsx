...
import { GitBranch, icons, Loader2, Plus, Shield, Trash2 } from "lucide-react";
...
import { URLField } from "@/components/utils/URLField";
import { useToast } from "@/hooks/use-toast";
import { cn, searchSimpleIcons } from "@/lib/general-utils";
  ...
  return (
    <div className="space-y-5">
      {isPrivateSystem && (
        <div className="flex items-center gap-3 rounded-lg border border-border/50 bg-muted/30 p-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-sm">Private System</span>
          </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <Label htmlFor="systemName" className="font-medium text-sm">
            System Display Name
          </Label>
        ...
        <Input
          ...
          className="h-10 rounded-lg border border-border/50 bg-muted/30 shadow-sm transition-colors focus:border-primary/50"
        />
      </div>
      ...
      {!isNewSystem && (
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Label htmlFor="systemId" className="font-medium text-sm">
              System ID
            </Label>
          ...
          <Input
            ...
            value={system.id}
            disabled
            className="h-10 rounded-lg border border-border/50 bg-muted/30 font-mono text-xs shadow-sm"
          />
        </div>
      )}
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <Label htmlFor="apiEndpoint" className="font-medium text-sm">
            System Endpoint
          </Label>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <Label htmlFor="systemIcon" className="font-medium text-sm">
            System Icon
          </Label>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="h-10 flex-1 justify-between rounded-lg border border-border/50 bg-muted/30 shadow-sm"
        ...
        {isIconMenuOpen && (
          <div
            className={cn(
              "mt-2 rounded-xl p-3",
              "border border-border/50 bg-muted/30 shadow-sm backdrop-blur",
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="h-9 border-border/50 bg-muted/40"
                />
              ...
              <div className="space-y-2">
                <div className="font-semibold text-[11px] text-muted-foreground">Simple Icons</div>
                    ...
                    {simpleIconSuggestions.map((icon) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="truncate font-medium text-[11px]">{icon.title}</span>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              <div className="space-y-2">
                <div className="font-semibold text-[11px] text-muted-foreground">Lucide Icons</div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between rounded-lg border border-border/50 bg-muted/30 p-3">
            ...
            {(envState === "linked-dev" || envState === "linked-prod") && (
              <div className="flex items-center gap-2 rounded-full border border-border/30 bg-muted/50 px-3 py-1">
            ...
            <div>
              ...
              {(envState === "linked-dev" || envState === "linked-prod") && (
                <Button
                  ...
                  className="h-8 gap-1.5 text-destructive/70 hover:bg-destructive/10 hover:text-destructive"
                >
...
function sanitizeSystemId(id: string): string {
  if (id.startsWith("postgres://") || id.startsWith("postgresql://")) {
    try {
      ...
      const cleanId = `DB-${host}-${database}`;
