...
import { cn, truncateValue } from "@/lib/general-utils";
import { truncateTemplateValue } from "@/lib/templating-utils";
...
export function TemplateChip({
  ...
  const chipContent = (
    <button
      ...
      tabIndex={0}
      className={cn(
        "inline-flex select-none items-center gap-1 rounded border px-1.5 py-0.5 font-mono text-xs",
