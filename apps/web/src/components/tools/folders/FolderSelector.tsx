...
const FOLDER_STORAGE_KEY_BASE = "ambios-selected-folder";
const UNCATEGORIZED = "";
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-[220px] justify-between pr-2 pl-3"
        >
              ...
              {filteredFolders.map((folder) => {
                ...
                return (
                  ...
                  >
                    ...
                    {folder.count > 0 && (
                      <span className="ml-auto text-muted-foreground text-xs">{folder.count}</span>
                    )}
                  </CommandItem>
                );
              })}
              ...
              <>
                ...
                <CommandGroup className="p-1">
                  ...
                  >
                    ...
                    <span className="ml-auto text-muted-foreground text-xs">{archivedCount}</span>
                  </CommandItem>
                </CommandGroup>
              </>
            )}
