...
import { findTemplateForSystem, type ToolCall } from "@ambios-ai/shared";
...
import { triggerOAuthFlow } from "@/lib/oauth-utils";
      ...
      <div className="space-y-4">
        {system && (
          <div className="flex items-center gap-2 text-sm">
            ...
            {environment === "dev" && (
              <span className="rounded bg-amber-100 px-1.5 py-0.5 font-medium text-amber-800 text-xs dark:bg-amber-900/30 dark:text-amber-400">
                DEV
              </span>
            )}
