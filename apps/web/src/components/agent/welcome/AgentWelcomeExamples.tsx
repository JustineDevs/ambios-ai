...
import { getSimpleIcon, isDarkIconHex } from "@/lib/general-utils";
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-2">
      ...
      <div className="flex items-center justify-between">
        <span className="font-medium text-foreground text-sm">Tool Examples</span>
        {onDismiss && (
      ...
      <div className="flex flex-wrap gap-2">
        {TOOL_EXAMPLES.map((tool) => (
          <Button
            ...
            variant="outline"
            size="sm"
            className="h-auto whitespace-normal px-3 py-2 text-left text-xs transition-colors hover:bg-primary hover:text-primary-foreground"
            onClick={() => {
