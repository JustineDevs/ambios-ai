...
export default function WelcomePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      document.cookie = `ambios_tenant_email=${encodeURIComponent(email)}; path=/; max-age=31536000; SameSite=Strict`;
      document.cookie =
        "ambios_tenant_emailEntrySkipped=false; path=/; max-age=31536000; SameSite=Strict";
  ...
  const handleSkip = async () => {
    try {
      ...
      document.cookie =
        "ambios_tenant_emailEntrySkipped=true; path=/; max-age=31536000; SameSite=Strict";
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="pointer-events-none absolute top-12 -left-24 h-64 w-64 rounded-full bg-foreground/5 blur-3xl" />
      <div className="pointer-events-none absolute right-0 bottom-0 h-72 w-72 rounded-full bg-foreground/5 blur-3xl" />
      <div className="absolute inset-0 bg-background/60 backdrop-blur-sm" />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        <Card className="fade-in zoom-in-95 w-full max-w-md animate-in overflow-hidden rounded-2xl border border-border/50 bg-gradient-to-br from-muted/50 to-muted/30 shadow-2xl backdrop-blur-xl duration-200 dark:from-muted/50 dark:to-muted/30">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-11 rounded-xl border-border/50 bg-background/45 shadow-sm backdrop-blur-sm"
                />
              </div>
          ...
          <CardFooter className="border-border/35 border-t bg-background/20 pt-4 text-muted-foreground text-xs">
