...
export const TOOL_METADATA: Record<string, ToolMeta> = {
  ...
  run_tool: {
    ...
    summary:
      "Executes a ambios tool via tool id or draft id with an optional payload and returns results",
    category: "execution",
  },
  edit_tool: {
  ...
  create_system: {
    ...
    summary: "Registers a new ambios system with URL, auth, and docs",
    category: "systems",
  },
  edit_system: {
    displayName: "Edit System",
    summary: "Updates an existing ambios system's configuration or credentials",
    category: "systems",
  },
  call_system: {
  ...
  find_tool: {
    ...
    summary: "Looks up an existing ambios tool by ID or search query",
    category: "context",
  },
  find_system: {
  ...
  load_skill: {
    ...
    summary: "Loads ambios skills into context",
    category: "context",
  },
  inspect_role: {
...
export const AGENT_SUMMARIES: Record<string, AgentSummary> = {
  [AgentType.MAIN]: {
    title: "ambios agent",
    description:
      "The most comprehensive agent that builds, tests, and deploys system integrations end-to-end. Manages systems, builds multi-step tools, handles auth, and gathers context from the web, existing ambios systems and their documentation.",
  },
