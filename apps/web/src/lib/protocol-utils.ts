...
import { Database, FolderOpen, HardDrive, Network, Server } from "lucide-react";
...
export function generateTunnelInstructions(systemUrl: string, protocol: string): string {
  const baseInstruction =
    "This system is connected via a Secure Gateway (on-premises tunnel agent). The URL will be automatically routed through the tunnel in the backend.";
