...
function copyRequestParams(params: Record<string, unknown> | undefined): Record<string, unknown> {
  ...
  request<T extends ZodType<object>>(
    ...
    return new Promise((resolve, reject) => {
      ...
      if (options?.onprogress) {
        ...
        const params = copyRequestParams(request.params as Record<string, unknown> | undefined);
        const metadata = copyRequestParams(params._meta as Record<string, unknown> | undefined);
        metadata.progressToken = messageId;
