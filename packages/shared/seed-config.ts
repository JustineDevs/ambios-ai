...
All responses are JSON. Time series data is keyed by date/time strings.`,
    ...
    {
      id: "ambios-email",
      name: "ambios Email Service",
      url: "https://api.ambios.cloud/v1/notify/email",
      templateName: "ambiosEmail",
      icon: "lucide:mail",
      credentials: {},
      specificInstructions:
        "Send emails to your own email address. Use POST https://api.ambios.cloud/v1/notify/email with your API key in the Authorization header. Request body: { subject: string, body: string }. The email will be sent to the email address you signed up with.",
      documentationUrl: "https://docs.ambios.cloud/guides/email-service",
      documentation: `# ambios Email Service

A simple email notification service that sends emails to your registered ambios account email address.

## Endpoint
\`POST https://api.ambios.cloud/v1/notify/email\`

## Authentication
Include your ambios API key in the Authorization header:
\`\`\`
...
## Notes
- Emails are sent FROM ambios's notification system
- Emails are sent TO the email address associated with your ambios account
- HTML content is supported for rich formatting
- Rate limits apply based on your ambios plan`,
    },
    {
      id: "lego-database",
      name: "Lego Sets Database",
      url: "postgresql://test_user:LegoTest2026!xK9m@files.ambios.ai:5432/lego",
      templateName: "postgres",
      credentials: {
        user: "test_user",
        password: "LegoTest2026!xK9m",
        hostname: "files.ambios.ai",
        port: "5432",
        database_name: "lego",
      },
      specificInstructions:
        ...
        },
        {
          ...
          config: {
            ...
            headers: {
              ...
              Authorization: "Bearer <<ambios-email_apiKey>>",
            },
            body: `<<(sourceData) => {
                ...
                body: \`
                  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                      <h1 style="color: white; margin: 0; font-size: 24px;">🎉 Welcome to ambios!</h1>
                    ...
                    <div style="margin-top: 24px; padding: 20px; background: #fefce8; border-radius: 12px; border: 1px solid #fef08a;">
                      <p style="margin: 0; color: #854d0e; font-size: 14px;">
                        <strong>💡 This is a demo tool!</strong> You just ran your first ambios tool. 
                    ...
                    <div style="margin-top: 24px; text-align: center; color: #94a3b8; font-size: 12px;">
                      Powered by <a href="https://ambios.cloud" style="color: #667eea; text-decoration: none;">ambios</a> — The AI-native integration platform
                    </div>
                  </div>
                \`
              });
            }>>`,
            systemId: "ambios-email",
          },
        },
      ],
      inputSchema: {
